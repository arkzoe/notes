...
| public String getHostAddressO                                              | 获取该ip地址对象中的ip地址信息            |
| public static InetAddress getByName(String host)throwsUnknownHostException | 根据ip地址或者域名，返回一个inetAddress对象 |
