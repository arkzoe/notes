...
1. 下载JDK软件
    ...
    ![image-20221017163411651](https://image-set.oss-cn-zhangjiakou.aliyuncs.com/img-out/2022/10/17/20221017163411.png)
...
10. 打开浏览器，输入：
    ...
    [http://centos:8080](http://centos:8080/)或[http://192.168.88.130:8080](http://192.168.88.130:8080/)
...
_Nginx_ (engine x) 是一个高性能的HTTP和反向代理web服务器，同时也提供了IMAP/POP3/SMTP服务。
...
6. 启动后浏览器输入Linux服务器的IP地址或主机名即可访问
    ...
    [http://192.168.88.130](http://192.168.88.130/) 或 [http://centos](http://centos/)
    
    > ps：80端口是访问网站的默认端口，所以后面无需跟随端口号
    > 
    > 显示的指定端口也是可以的比如：
    > 
    > - [http://192.168.88.130:80](http://192.168.88.130/)
    >     
    > - [http://centos:80](http://centos/)
    >     
...
7. 浏览器打开管理控制台
    ...
    [http://192.168.88.130:15672](http://192.168.88.130:15672/)
...
[全文搜索](https://baike.baidu.com/item/%E5%85%A8%E6%96%87%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E)属于最常见的需求，开源的 [Elasticsearch](https://www.elastic.co/) （以下简称 es）是目前全文搜索引擎的首选。
...
6. 测试
    ...
    浏览器打开：[http://ip:9200/?pretty](http://ip:9200/?pretty)
...
2. 验证HDFS，浏览器打开：[http://node1:9870](http://node1:9870/)
...
3. 验证YARN，浏览器打开：[http://node1:8088](http://node1:8088/)
...
HBase 是一种[分布式](https://so.csdn.net/so/search?q=%E5%88%86%E5%B8%83%E5%BC%8F&spm=1001.2101.3001.7020)、可扩展、支持海量数据存储的 NoSQL 数据库。
...
10. 验证HBase
    ...
    浏览器打开：[http://node1:16010](http://node1:16010/)，即可看到HBase的WEB UI页面
...
8. 打开Spark监控页面，浏览器打开：[http://node1:8081](http://node1:8081/)
...
浏览器打开：[http://node1:3000](http://node1:3000/)
